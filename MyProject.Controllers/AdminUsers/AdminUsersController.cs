...
using MyProject.Controllers.AdminUsers.ViewModels;

namespace MyProject.Controllers.AdminUsers
{
    public class AdminUsersController : BaseController
    {
        ...
        public ActionResult ChangePassword(ChangePasswordModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                return AlertMsg("修改成功！");
            }
            return View();
        }

        public ActionResult AlertMsg(string msg)
        {
            var script = string.Format("<script>alert('{0}');window.top.location.href='/Account/LogOn';</script>", msg);
